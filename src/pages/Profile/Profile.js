                  ...
                  <div class="flex-fill main-profile-info">
                    ...
                    <div class="d-flex mb-0">
                      ...
                      <div class="me-4">
                        ...
                        <p class="mb-0 fs-11 op-5 text-fixed-white">
                          Followers
                        </p>
                      </div>
                      <div class="me-4">
                ...
                <div class="p-4 border-bottom border-block-end-dashed">
                  <div class="mb-4">
                    ...
                    <p class="fs-12 text-muted op-7 mb-0">
                      I am <b class="text-default">Sonya Taylor,</b> here by
                      conclude that,i am the founder and managing director of
                      the prestigeous company name laugh at all and acts as the
                  ...
                  <div class="mb-0">
                    ...
                    <div class="mb-0">
                      <p class="mb-1">
                        <a href="https://www.spruko.com/" class="text-primary">
                ...
                <div class="p-4 border-bottom border-block-end-dashed">
                  ...
                  <div>
                    <a href="javascript:void(0);">
                      <span class="badge bg-light text-muted m-1">
                        Cloud computing
                      </span>
                    </a>
                    <a href="javascript:void(0);">
                      ...
                      <div class="d-sm-flex align-items-top">
                        ...
                        <div class="ms-sm-2 ms-0 mt-sm-0 mt-1 fw-semibold flex-fill">
                          ...
                          <span class="fs-11 text-muted op-7">
                            aliciasierra389@gmail.com
                          </span>
                        </div>
                        <button class="btn btn-light btn-wave btn-sm">
                          Follow
                        </button>
                      </div>
                    </li>
                ...
                <div class="card custom-card">
                  <div class="card-body p-0">
                    <div class="p-3 border-bottom border-block-end-dashed d-flex align-items-center justify-content-between">
                      <div>
                        <ul
                          class="nav nav-tabs mb-0 tab-style-6 justify-content-start"
                          id="myTab"
                          role="tablist"
                        >
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              aria-selected="true"
                            >
                              <i class="ri-gift-line me-1 align-middle d-inline-block"></i>
                              Activity
                            </button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              aria-selected="false"
                            >
                              <i class="ri-bill-line me-1 align-middle d-inline-block"></i>
                              Posts
                            </button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              aria-selected="false"
                            >
                              <i class="ri-money-dollar-box-line me-1 align-middle d-inline-block"></i>
                              Friends
                            </button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              aria-selected="false"
                            >
                              <i class="ri-exchange-box-line me-1 align-middle d-inline-block"></i>
                              Gallery
                            </button>
                          </li>
                        </ul>
                    ...
                    <div class="p-3">
                      <div class="tab-content" id="myTabContent">
                        <div
                          class="tab-pane show active fade p-0 border-0"
                        ...
                        <div
                          class="tab-pane fade p-0 border-0"
                          id="posts-tab-pane"
                          role="tabpanel"
                              ...
                              <div class="d-sm-flex align-items-center lh-1">
                                ...
                                <div class="flex-fill me-sm-2 mt-1 mt-sm-0">
                                  <div class="input-group">
                                    ...
                                    />
                                    <button
                                      class="btn btn-light btn-wave d-none d-sm-block"
                                      type="button"
                                    >
                                ...
                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                  <div class="rounded border">
                                    <div class="p-3 d-flex align-items-top flex-wrap">
                                      ...
                                      <div class="d-flex align-items-top">
                                        <div>
                                          <span class="badge bg-secondary-transparent me-2">
                                            Travel
                                          </span>
                                        </div>
                                        <div class="dropdown">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item">
                        <div class="d-flex flex-wrap align-items-center">
                          <div class="me-2 fw-semibold">Name :</div>
                      ...
                      <li class="list-group-item">
                        <div class="d-flex flex-wrap align-items-center">
                          <div class="me-2 fw-semibold">Designation :</div>
                      ...
                      <li class="list-group-item">
                        <div class="d-flex flex-wrap align-items-center">
                          <div class="me-2 fw-semibold">Experience :</div>
